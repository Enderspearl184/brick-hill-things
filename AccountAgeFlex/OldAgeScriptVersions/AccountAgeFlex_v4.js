...
async function writeBoxPacket(p, y) {
	...
	if (y=="Member2") {
		p.message("You have access to the Mint level of the Small Tower!")
		return
	}
	
	if (y=="Member3") {	
		p.message("You have access to the Ace level of the Small Tower!")
		return
	}

	if (y=="Member4") {
		p.message("You have access to the Royal level of the Small Tower!")
		return
	}
