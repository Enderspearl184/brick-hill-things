...
//fun fact this was typed MANUALLY because i couldn't figure out how to code it in to just get the right coordinates.
const Plates={
	1: {
...
Game.on("initialSpawn", (player) => {
	player.setPosition(new Vector3(player.plate.corner1.x+25,player.plate.corner1.y+25,0)) //teleport them to the center of their plate
