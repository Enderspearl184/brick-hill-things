...
//yes this is very terrible spaghetti code. i don't care as long as it works
//it doesn't work. fuck.
/*
let plate1 = world.bricks.find(brick => brick.name=="Plate1")
let plate2 = world.bricks.find(brick => brick.name=="Plate2")
let plate3 = world.bricks.find(brick => brick.name=="Plate3")
let plate4 = world.bricks.find(brick => brick.name=="Plate4")
let plate5 = world.bricks.find(brick => brick.name=="Plate5")
let plate6 = world.bricks.find(brick => brick.name=="Plate6")
let plate7 = world.bricks.find(brick => brick.name=="Plate7")
let plate8 = world.bricks.find(brick => brick.name=="Plate8")
let plate9 = world.bricks.find(brick => brick.name=="Plate9")
console.log(plate1.position)
*/


//possible 9 corners: 24, 124 => -25, 75
const Plates={
	1: {
	...
	5: {
		corner2: new Vector3(124,24,0),
		corner1: new Vector3(75,-25,0),
		open: true
	},
	6: {
		corner1: new Vector3(-25,-25,0),
		corner2: new Vector3(24,24,0),
		open: true
	},
	7: {
		corner1: new Vector3(-125,-25,0),
		corner2: new Vector3(-76,24,0),
		open: true
	},
	8: {
		corner1: new Vector3(-25,-125,0),
		corner2: new Vector3(24,-76,0),
		open: true
	},
	9: {
		corner2: new Vector3(24,124,0),
		corner1: new Vector3(-25,75,0),
		open:true
	}
}
